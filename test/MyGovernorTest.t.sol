...
contract MyGovernorTest is Test {
    ...
    uint256 public constant MIN_DELAY = 3600; // 1 Hour -> This is the delay time after a vote passes
    uint256 public constant VOTING_DELAY = 1; // how many blocks to a vote is active
    ...
    function testCannotUdateBoxWithoutGovernance() public {
        vm.expectRevert();
        box.store(1);
    }
    ...
    function testGovernanceUpdateBox() public {
        ...
        // 2. Vote
        string memory reason = "trying to lock-in";
